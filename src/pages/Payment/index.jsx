...
const Payment = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen mx-3 pb-9">
      ...
      {/* totalPrice */}
      <div className="mx-6 mt-6 leading-10 mb-16">
      ...
      {/* orderItem */}
      <p className="text-xl font-poppins pl-2 pt-8 mb-5">Order Item</p>
      ...
      <div className="h-20 flex justify-between items-end">
        ...
        <button className="w-52 h-full text-[#FFFFFF] bg-[#3C2F2F] rounded-2xl" onClick={() => navigate(`/orderConfirmation`)}>Pay Now</button>
      </div>
    </div>
  )
}
